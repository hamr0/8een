...
| **M5 — dossier** | The refutation page with the ~~live~~ **recorded** demo embedded (amended by D9, 2026-07-16: GitHub Pages, recorded unedited demo + reproduce-it-yourself path; no live tier). | "The argument — including its own corrections and open gaps — survives being written down with citations." |
